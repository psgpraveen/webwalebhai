...
// Define the HomeHero component props with optional 'habhaiha' prop
interface HomeHeroProps {
  habhaiha?: boolean; // Optional prop, defaults to false if not passed
}
...
export default function HomeHero({ habhaiha = false }: HomeHeroProps) {
  useEffect(() => {
    console.log(habhaiha); // Log the value of habhaiha prop
  }, [habhaiha]);

  return (
    <>
      {/* Conditionally render Header based on habhaiha */}
      {habhaiha ? " " : <Header />}
      ...
      <section className="bg-white py-14 px-4 text-center relative overflow-x-hidden">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-base text-gray-600 mb-8">
            Webwalebhai offers a wide range of <span className="font-semibold text-blue-700">website</span> design services in India:
            business sites, personal blogs, web portals, micro-sites, e-commerce, static and dynamic websites, and more. We empower
            brands of all sizes to stand out online with modern, scalable, and high-converting solutions.
          </p>
        </div>
        ...
        {/* Conditionally render the "Get a Free Quote" button */}
        {!habhaiha && (
